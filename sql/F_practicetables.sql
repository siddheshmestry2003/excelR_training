...
Create table emp_1 (eid Integer, emp_name varchar(111),branch varchar(111));
insert into emp_1 values(100,'Harry','Mumbai'),(101,'Peter','Delhi'),
(102,'Daniel','Calcuta'),(103,'Drake','Goa');

Create table dep_1(dep_id integer, d_name varchar(111), eid integer);
insert into dep_1 values(10,'HR',100),(20,'Finance',102);

Create table department_3 (first_namr varchar(111), last_name varchar(111),
designation varchar(111), email_id varchar(111));

insert into department_3 values('Rehan','Singh','Project Manager','rehansingh@gmail.com'),
('Daniel','Brown','Associate Manager',NULL),('Drake','Hunold',NULL,NULL),('Tony',NULL,NULL,NULL);
...
INSERT INTO Product(ProductID, Product_name, CustomerID) VALUES
...
Create table emp_99 (eid Integer, emp_name varchar(111),branch varchar(111));
insert into emp_99 values(100,'Harry','Mumbai'),(101,'Peter','Delhi'),
(102,'Daniel','Calcuta'),(103,'Drake','Goa');

Create table dept_11(dep_id integer, d_name varchar(111), eid integer);
insert into dept_11 values(10,'HR',100),(20,'Finance',102);

Create table department_333 (first_namr varchar(111), last_name varchar(111),
designation varchar(111), email_id varchar(111));

insert into department_333 values('Rehan','Singh','Project Manager','rehansingh@gmail.com'),
('Daniel','Brown','Associate Manager',NULL),('Drake','Hunold',NULL,NULL),('Tony',NULL,NULL,NULL);
